...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/js/swiper_bundle.js"></script>
<!--js 연동-->
<script type="text/javascript"
...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/header_sector1.css?after">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/header_sector2.css?after">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/container.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/listpage.css">
<title>퍼퓸가이드</title>
</head>
			...
			<div class="sector2 cboth" id="category_top">
									...
									<div id="slide_category_list">
										...
										<div class="category_brand">
											<div class="open">
												...
												<div id="myBrand" id="brand_sort_outer" class="slide_brand"
													style="top: -600px; opacity: 0; height: 0px;">
													<ul class="brand_sort">
														<h1 class="brand_sort_title">
															Brands <a href="javascript:void(0)" class="closebrand"
																onclick="closeBrand()"> <img
																src="${pageContext.request.contextPath}/resources/image/close_btn.png"
																alt="닫기">
															</a>
														</h1>
														<!--내부 스크롤 영역-->
														<div class="scroll_wrapper scrollbar_inner"
															style="position: relative;">
															<li class="scrollbar_inner scroll_content"
																style="height: auto; margin-bottom: 0px; margin-right: 0px; max-height: 600px;">
																<!--브랜드명 클릭시 listpage.html로 이동(./listpage.html)--> <!--.jsp로 변경 후 listpage.html에 DB값 호출-->
										...
										<div class="category_brand">
											<div class="open">
												...
												<div id="myGender" id="brand_sort_outer" class="slide_brand"
													style="top: -200px; opacity: 0; height: 0px;">
													<ul class="brand_sort">
														<h1 class="brand_sort_title">
															Gender <a href="javascript:void(0)" class="closebrand"
																onclick="closeGender()"> <img
																src="${pageContext.request.contextPath}/resources/image/close_btn.png"
																alt="닫기">
															</a>
														</h1>
														...
														<div class="scroll_wrapper scrollbar_inner"
															style="position: relative;">
															<li class="scrollbar_inner scroll_content"
																style="height: auto; margin-bottom: 0px; margin-left: 30px; margin-right: 0px; max-height: 600px; overflow: hidden;">
																<!--성별 클릭시 listpage.html로 이동(./listpage.html)--> <!--.jsp로 변경 후 listpage.html에 DB값 호출-->
																<div class="brand_link">
																	<div class="brand_group" style="display: block;">
																		<h1>
																			<a href="./listpage.html">남자</a>
																		</h1>
																	</div>
																</div>
																<div class="brand_link">
										...
										<div class="category_brand">
											<div class="open">
												...
												<div id="myAccords" id="brand_sort_outer"
													class="slide_brand"
													style="top: -300px; opacity: 0; height: 0px;">
													<ul class="brand_sort">
														<h1 class="brand_sort_title">
															Accords <a href="javascript:void(0)" class="closebrand"
																onclick="closeAccords()"> <img
																src="${pageContext.request.contextPath}/resources/image/close_btn.png"
																alt="닫기">
															</a>
														</h1>
														...
														<div class="scroll_wrapper scrollbar_inner"
															style="position: relative;">
															<li class="scrollbar_inner scroll_content"
																style="height: auto; margin-bottom: 0px; margin-left: 70px; margin-right: 0px; max-height: 600px; overflow: hidden;">
																<!--계열 클릭시 listpage.html로 이동(./listpage.html)--> <!--.jsp로 변경 후 listpage.html에 DB값 호출-->
																<div class="brand_link">
																	<div class="brand_group" style="display: block;">
																		<h1>
																			<a href="./listpage.html">프루티</a>
																		</h1>
																	</div>
																</div>
																<div class="brand_link">
																...
																<div class="brand_link">
																	<div class="brand_group" style="display: block;">
																		<h1>
																			<a href="./listpage.html">프레쉬/아로마</a>
																		</h1>
																	</div>
																</div>
															</li>
										...
										<ul class="category_list">
											<li class="no_child"><a href="./listpage.html"
												class="category">EDT</a></li>
											<li class="no_child"><a href="./listpage.html"
												class="category">EDP</a></li>
										</ul>
									</div>
								</div>
							</ul>
				...
				<div id="mySearch" class="slide_search"
					...
					<div class="search_inner">
						...
						<form id="searchBarForm" action="./search.html" method="get"
							...
							<div class="search_field">
								<fieldset title="검색어를 입력해주세요.">
									<input id="keyword" name="keyword" fw-filter="" fw-label="검색어"
										fw-msg="" class="inputTypeText" placeholder="향수 이름으로 검색"
										onmousedown="clickSearchForm(this)" value="" type="text">
									<input type="image"
										src="${pageContext.request.contextPath}/resources/image/top_search_icon.png"
										class="btn-sch" alt="검색이미지"
										onclick="submitSearchBanner(this); return false;">
								</fieldset>
							</div>
						</form>
						<!--세부검색 영역 (삭제? 보류)-->
			...
			<div id="contents">
				...
				<div class="main_content" id="">
					...
					<div class="main_title cboth">
						<!--.title_t 에 브랜드명 불러오기-->
						<div class="title_t">LIST PAGE SAMPLE</div>
					</div>
								...
								<li style="width: 232px; margin-right: 30px;">
									<div class="box">
										<div class="thumbnail">
											<!--향수 이미지-->
											<div class="prdImg">
												<a href="#" class="_evt_tracker"> <img src="" alt="샘플사진">
												</a>
											</div>
										</div>
										<div class="description">
											<!--향수 이름-->
											<div class="name">
												<a href="#" class="_evt_tracker"> <span
													style="font-size: 15px; color: #111111;">샘플향수</span>
												</a>
											</div>
											<!--대표계열-->
											<ul class="spec">
												<li rel="계열" style="margin-left: 0px !important;"><span
													style="font-size: 14px; color: #999999;">샘플계열</span></li>
											</ul>
										</div>
									</div>
								</li>
